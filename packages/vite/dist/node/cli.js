...
import { x as colors, k as createLogger, r as resolveConfig } from './chunks/dep-SSKHGyei.js';
...
cli
    ...
    // is ok here
    const { createServer } = await import('./chunks/dep-SSKHGyei.js').then(function (n) { return n.A; });
    try {
...
cli
    ...
    .action(async (root, options) => {
    filterDuplicateOptions(options);
    const { build } = await import('./chunks/dep-SSKHGyei.js').then(function (n) { return n.C; });
...
cli
    ...
    .action(async (root, options) => {
    filterDuplicateOptions(options);
    const { optimizeDeps } = await import('./chunks/dep-SSKHGyei.js').then(function (n) { return n.B; });
    try {
...
cli
    ...
    .action(async (root, options) => {
    filterDuplicateOptions(options);
    const { preview } = await import('./chunks/dep-SSKHGyei.js').then(function (n) { return n.D; });
    try {
